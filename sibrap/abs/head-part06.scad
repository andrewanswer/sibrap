...
// updated by Andrew Answer (http://answe.ru) for SibRap project 2015
...
// отверстие под винт
translate([0,0,-1]) rotate([0,0,0])cylinder(r=3.4/2,h=20,$fn=20);
// отверстие под гайку
translate([0,0,pulley_t_ht-3.17+0.05]) rotate([0,0,0])cylinder(r=6.55/2,h=3.17,$fn=6);
